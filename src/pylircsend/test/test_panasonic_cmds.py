...
class TestPanasonicA75C2665(unittest.TestCase):
    ...
    setups = [
        { # 0
            'power': 'off', 'temp': 24, 'mode':'cool', 'fan': 'auto', 'air_dir': 'auto',
        ...
        { # 1
            'power': 'on', 'temp': 24, 'mode':'cool', 'fan': 'auto', 'air_dir': 'auto',
        ...
        { # 2
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'auto', 'air_dir': 'auto',
        ...
        { # 3
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'high', 'air_dir': 'auto',
        ...
        { # 4
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'high', 'air_dir': '1',
        ...
        { # 5 
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'high', 'air_dir': '5',
        ...
        { # 6
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'high', 'air_dir': '3',
        ...
        { # 7
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'high', 'air_dir': '4',
        ...
        { # 8
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'high', 'air_dir': '2',
        ...
        { # 9
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'low', 'air_dir': 'auto',
        ...
        { # 10
            'power': 'on', 'temp': 25, 'mode':'cool', 'fan': 'medium', 'air_dir': 'auto',
        ...
        { # 11 - does not work. temperature wrong. in mode 1 not relevant?
            'power': 'on', 'temp': 26, 'mode':'auto', 'fan': 'auto', 'air_dir': 'auto',
        ...
        { # 12
            'power': 'on', 'temp': 26, 'mode':'heat', 'fan': 'auto', 'air_dir': 'auto',
        ...
        { # 13
            'power': 'on', 'temp': 26, 'mode':'cool', 'fan': 'high', 'air_dir': 'auto',
        ...
        { # 14
            'power': 'on', 'temp': 26, 'mode':'dry', 'fan': 'auto', 'air_dir': 'auto',
